...
const Transition = React.forwardRef(function Transition(props, ref) {
 ...
 function Print_pdgeneralagendaofthequarter(props) {
        ...
        <Container className="container-print"> 
         ...
         <tr> 
            ...
            <td rowSpan='2' colSpan='2' >
                ...
                <div className="mt-4">
                   <PdGeneralAgendaForTheQuarterTable ClassId={props.ClassId}   />
                </div>
                <div >
...
export default Print_pdgeneralagendaofthequarter
