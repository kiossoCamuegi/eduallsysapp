...
import PdQuarterFinalByClassTable from '../Table/PdQuarterFinalByClassTable';
...
const Transition = React.forwardRef(function Transition(props, ref) {
 ...
 function Print_quarterlynotesbyclass(props) {
  ...
  async function StudentData(e){
    if(Math.floor(e) >= 0){
        ...
        if(response.data.length >= 1) {    
            let outputs = document.querySelectorAll(".paper-container.fl1 .header-print");
      ...
      <Dialog  fullScreen   open={open}   onClose={handleClose}  TransitionComponent={Transition}   >
        <AppBar sx={{ position: 'relative' }}>
          <Toolbar> 
           ...
           <div> <Title>Imprimir Pauta final por turma</Title></div>
        ...
        <Container className="container-print"> 
          <div className="paper-container fl1" ref={containerPrint}>
            <div className="ed-center mb-3"> 
                 <div className="header-print"></div>  
              </div>
              <div className="ed-space mt-4 mb-3">
                 <div className="ed-flex"></div>
                 <div className="ed-flex small-line-text">
                    <h3>Pauta Nº</h3>
            ...
            <td  colSpan='5' >
                  <div className="ed-center">  
                       <h1>  <div>{(props.ClassId !== null && props.ClassId*1 !== NaN )  ? <GetCourse_byclass ID={props.ClassId} /> : <></> } </div></h1>
                  </div>
              </td>  
            </tr> 
            <tr>
            ...
            <td>
              ...
              <td>
                ...
                <div className="mt-4">
                <PdQuarterFinalByClassTable  Filters={{subject:props.SubjectId, class:props.ClassId}} ClassId={props.ClassId} /> 
                </div>
                <div >
                <div className="footer-content mt-4">  
                <div className="mt-4 ed-center" contentEditable>Localização e data atual aqui</div>
                    <div className="ed-space" style={{alignItems:"flex-end"}}>
                    <div className="block-dets"> 
                        <div className="ed-block nb-item mt-2 mb-2 ed-flex">
                            <div className="ed-block">
                                <div className="ed-center"> <h3 contentEditable>O conselho de notas</h3></div>
                                <div className="ed-flex"> 1. <div className="line"></div></div>
                            </div> 
                            </div>
                            <div className="ed-block nb-item mt-2 mb-2 ed-flex">
                              2. <div className="line"></div>
                            </div>
                            <div className="ed-block nb-item mt-2 mb-2 ed-flex">
                               3. <div className="line"></div>
                            </div>
                        </div>
                        <div className="ed-block ed-center block-line mb-2">
                                <h3 contentEditable>O Diretor Pedagógico</h3>
                            <div className="line"></div>
                        </div>
                        <div className="ed-block ed-center block-line mb-2">
                                <h3 contentEditable>O Diretor</h3>
                            <div className="line"></div>
                        </div>
                    </div>
                </div>
...
export default Print_quarterlynotesbyclass
