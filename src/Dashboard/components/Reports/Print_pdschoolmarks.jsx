...
const Transition = React.forwardRef(function Transition(props, ref) {
 ...
 function Print_pdschoolmarks(props) {
      ...
      <Dialog  fullScreen   open={open}   onClose={handleClose}  TransitionComponent={Transition}   >
        <AppBar sx={{ position: 'relative' }}>
          <Toolbar> 
           ...
           <div> <Title>Imprimir Boletim escolar</Title></div>
        ...
        <Container className="container-print"> 
          <div className="paper-container fl2" ref={containerPrint}>
            ...
            <Table responsive bordered  >  
                  ...
                  <PdSchoolMarksTable  StudentCode={props.StudentId}  ClassId={props.ClassId}  /> 
...
export default Print_pdschoolmarks
