...
import PdFeaturesNotesTable from '../../components/Table/PdFeaturesNotesTable'
...
function PdFeatureNotes() {
document.title = "Notas do recurso";
...
const [CurrentClass, SetCurrentClass] = useState(null); 
  ...
  return (
    ...
    <CustomTableContainer title="Notas do recurso" content={<div>
    ...
    <div className="eduall-table">
       <div className="ed-table-container">
          <PdFeaturesNotesTable  ref={ChildRef} SubjectId={CurrentSubject} ClassId={CurrentClass} />
       </div> 
    </div>
   </div> }/>
    </div> 
