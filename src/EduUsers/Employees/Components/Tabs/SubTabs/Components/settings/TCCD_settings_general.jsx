...
function TCCD_settings_general() {
    const FORMURL = [
    ...
    const handleInput = (e)=>{  
      ...
      return (
        <div>
          <Container>
            <div className="box">
                <Form className='col'  method='post' encType='multipart/form-data'>
                <div className="ed-space">
                    <div className="ed-flex">
                       <Avatar className='df' src='' sx={{width:90,height:90}} />
                       <div className="ed-block ml-2">
                          <div><strong>Pr de Algebra</strong></div>
                          <div><small>desde 23 de Maio de 2022</small></div>
                       </div>
                    </div>
                    <div className="ed-flex">
                        <button className="btn-circle bg-success text-light"><Edit /></button> 
                    </div>
                </div>
                </Form>
            </div>
            <div className="box">
                <Form className='col'  method='post' encType='multipart/form-data'>
                  <div className="ed-space">
                     <div className="title"><h2>Informações pessoais</h2></div>
                     <div>
                        <button className="btn-circle bg-success text-light"><Edit /></button> 
                     </div>
                  </div>
                   <div className="ed-wrap ed-space">
                       <div className="ed-block mt-4">
                            ...
                            <Form.Control type='text'  placeholder="" name='employee_name'   value={'some text here'} /> 
                       </div>
                       <div className="ed-block mt-4">
                       ...
                       <div className="ed-block mt-4">
                            <Form.Label> <strong>Telefone (1)</strong> </Form.Label> 
                            <Form.Control type='text'  placeholder="" name='employee_name'   value={'some text here'} /> 
                       </div>
                       <div className="ed-block mt-4">
                            <Form.Label> <strong>Telefone (2)</strong> </Form.Label> 
                            <Form.Control type='text'  placeholder="" name='employee_name'   value={'some text here'} /> 
                       </div>
                   </div>
                </Form>
            ...
            <div className="box">
                ...
                <div className="ed-space">
                   ...
                   <div className="ed-wrap ed-space">
                       ...
                       <div className="ed-block mt-4">
                            <Form.Label> <strong>Morada</strong> </Form.Label> 
                            <Form.Control type='text'  placeholder="" name='employee_name'   value={'some text here'} /> 
                       </div>
                       <div className="ed-block mt-4">
...
export default TCCD_settings_general;
